...
encoding utf-8
Sheet 1 1
Title "HTS221 Breakout with 5V Level Shift"
Date "2020-03-19"
Rev "1"
Comp "SirBoard"
Comment1 "www.SirBoard.com"
Comment2 "16 Bit Temperature Range Extending from -40°C to +120°C"
Comment3 "16 Bit Humidity Range Extending from 0% rH to 100% rH"
Comment4 "HTS221 - SirBlue"
$EndDescr
Wire Wire Line
	5400 1700 5400 1900
Wire Wire Line
...
U 1 1 5E010087
P 5000 3150
F 0 "C2" H 5115 3195 50  0000 L CNN
F 1 "100nF" H 5115 3105 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 5038 3000 50  0001 C CNN
F 3 "~" H 5000 3150 50  0001 C CNN
F 4 "C42998" H 5000 3150 50  0001 C CNN "Part"
	1    5000 3150
	-1   0    0    -1  
$EndComp
Text GLabel 5475 3150 0    50   Input ~ 0
SDA_3V3
Text GLabel 5475 3050 0    50   Input ~ 0
SCL_3V3
...
U 1 1 5E29948C
P 6025 3725
F 0 "#PWR0102" H 6025 3475 50  0001 C CNN
F 1 "GND" H 6029 3553 50  0000 C CNN
F 2 "" H 6025 3725 50  0001 C CNN
...
Wire Wire Line
	4825 2500 5000 2500
$Comp
L SirBoard_Library:HTS221 U2
U 1 1 5E7E2B47
P 6025 3150
F 0 "U2" H 6618 3220 50  0000 L CNN
F 1 "HTS221" H 6618 3130 50  0000 L CNN
F 2 "SirBoardLibrary:HLGA-6L_2mmX2mm_P=0.75mm" H 6125 3600 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/1912041731_STMicroelectronics-HTS221TR_C91142.pdf" H 6125 3600 50  0001 C CNN
F 4 "C91142" H 6025 3150 50  0001 C CNN "Part"
	1    6025 3150
	1    0    0    -1  
$EndComp
Wire Wire Line
