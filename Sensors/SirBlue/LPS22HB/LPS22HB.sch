...
encoding utf-8
Sheet 1 1
Title "LPS22HB Breakout with 5V Level Shift"
Date "2020-03-18"
Rev "1"
Comp "SirBoard"
Comment1 "www.SirBoard.com"
Comment2 "16 Bit Temperature range extending from -40°C to +85°C"
Comment3 "24 bit Pressure with 260hPa to 1260hPa absolute pressure range"
Comment4 "LPS22HB - SirBlue"
$EndDescr
Wire Wire Line
	5400 1700 5400 1900
Wire Wire Line
...
F 4 "C42998" H 4625 3125 50  0001 C CNN "Part"
	...
	-1   0    0    -1  
$EndComp
Text GLabel 6525 2975 2    50   Input ~ 0
SDA_3V3
...
U 1 1 5E29948C
P 5975 3900
F 0 "#PWR0102" H 5975 3650 50  0001 C CNN
F 1 "GND" H 5979 3728 50  0000 C CNN
...
Wire Wire Line
	5075 2475 5825 2475
$Comp
L SirBoard_Library:LPS22HB U2
U 1 1 5E7242DE
P 6025 3175
F 0 "U2" H 5595 3145 50  0000 R CNN
F 1 "LPS22HB" H 5595 3055 50  0000 R CNN
F 2 "SirBoardLibrary:HLGA-10_2.0mmX2.0mm" H 6025 2975 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/STMicroelectronics-LPS22HBTR_C94049.pdf" H 6075 2825 50  0001 C CNN
F 4 "C94049" H 6025 3175 50  0001 C CNN "Part"
	1    6025 3175
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	5975 3725 5975 3825
Text GLabel 6525 3475 2    50   Input ~ 0
INT
