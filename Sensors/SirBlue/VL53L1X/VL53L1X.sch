...
encoding utf-8
Sheet 1 1
Title "VL53L1X Breakout with 5V Level Shift"
Date "2020-03-12"
Rev "1"
Comp "SirBoard"
Comment1 "Up to 400cm (4m) measuring distance"
Comment2 "Up to 50Hz ranging frequency"
Comment3 "VL53L1X - SirBlue"
Comment4 ""
$EndDescr
Wire Wire Line
	5250 1475 5250 1675
...
SDA_5V
$Comp
L Regulator_Linear:AP2127K-2.8 U1
U 1 1 5E6AEFE8
P 5900 1050
F 0 "U1" H 5900 1390 50  0000 C CNN
F 1 "AP2127K-2.8" H 5900 1300 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 5900 1375 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/NATLINEAR-LN5052B282MR-G_C185101.pdf" H 5900 1150 50  0001 C CNN
F 4 "185101" H 5900 1050 50  0001 C CNN "Part"
	1    5900 1050
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E6C4E72
P 4725 3100
F 0 "C2" H 4840 3145 50  0000 L CNN
F 1 "100nF" H 4840 3055 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 4763 2950 50  0001 C CNN
F 3 "~" H 4725 3100 50  0001 C CNN
F 4 "C42998" H 4725 3100 50  0001 C CNN "Part"
	1    4725 3100
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "GND" H 5904 3678 50  0000 C CNN
...
$Comp
L SirBoard_Library:VL53L1X U?
U 1 1 5E725D82
P 5900 3100
F 0 "U?" H 6493 3120 50  0000 L CNN
F 1 "VL53L1X" H 6493 3030 50  0000 L CNN
F 2 "SirBoardLibrary:LGA-12-2.4X4.8" H 6300 3800 50  0001 C CNN
F 3 "https://datasheet.lcsc.com/szlcsc/1811101103_STMicroelectronics-VL53L1CXV0FY-1_C190004.pdf" H 6300 3800 50  0001 C CNN
F 4 "C190004" H 6200 3750 50  0001 C CNN "Part"
	1    5900 3100
	1    0    0    -1  
$EndComp
$EndSCHEMATC
